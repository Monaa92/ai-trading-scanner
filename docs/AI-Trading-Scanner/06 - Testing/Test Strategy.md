...
Status: Phase 1–3 suites are complete on `main`. The Phase 4 review candidate adds focused strategy/configuration/proposal/causality cases and requires independent review. Trading, full replay, portfolio/risk and frontend tests remain future work. See [PROJECT_RULES](../../PROJECT_RULES.md), [[06 - Testing/Phase 3 Independent Review]] and [[06 - Testing/Phase 4 Independent Review]].
