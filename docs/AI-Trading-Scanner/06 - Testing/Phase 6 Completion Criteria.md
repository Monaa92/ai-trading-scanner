...
Status: **IN PROGRESS — CONTRACT FOUNDATION, IN-MEMORY SCHEDULER AND BOUNDED CAUSAL ORCHESTRATION ACCEPTED; END-TO-END REPLAY/EXECUTION AND 4+1 ARCHITECTURE DESIGNED BUT NOT IMPLEMENTED.**
