...
The Phase 5 coordinator remains the authoritative in-process reservation boundary. Phase 6 must later prove one transaction-safe causal transition from reservation through fill/cash/position update and exact idempotent replay. [[01 - Architecture/Execution/Replay and Simulation Architecture]] defines that unimplemented transaction and its multi-currency/durable target. Agent 5 descendants use attributed internal allocation envelopes inside one top-level ledger; they do not own independent capital. See [[01 - Architecture/Portfolio Accounting/Position Sizing]], [[01 - Architecture/Execution/Order Lifecycle]], [[02 - Agents & Strategies/Autonomous Survival Agent]], [[04 - Costs & Economics/Transaction Costs]] and [[06 - Testing/Phase 6 Completion Criteria]].
